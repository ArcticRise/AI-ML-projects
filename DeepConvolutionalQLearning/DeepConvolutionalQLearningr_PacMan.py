...
def preprocess_frame(frame):
  ...
  preprocess = transforms.Compose([transforms.Resize((128,128)), transforms.ToTensor()]) # Resize the image then transform it back into tensor object
...
number_episodes = 2300
maximum_number_t_steps_per_episode = 10000
...
for episode in range(1,number_episodes+1):
  ...
  if np.mean(scores_on_100_episodes) >= 510.0:
